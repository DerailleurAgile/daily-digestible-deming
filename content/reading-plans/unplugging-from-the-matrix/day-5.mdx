...
Note in the chart below there are ten signals. In an upcoming plan, we'll discuss how to create these charts and how to use them to diagnose whether a system is stable and predictable, and when to take action if not.

![Example PBC](./img/example-pbc.png)

## Reflection Questions
1. What types of data do you collect in your organization today? How is it used to make decisions about when to act?
2. How does management react to changes in a figure? On what basis? By what methods?
3. As a percentage, how much time is devoted to putting a fire out versus fixing the system that caused it?

## Today's Challenge
Track something over time (response time, error rate, sales, anything). Plot it. What do you see? Add a mean line to it. What do you notice about how many data points are above or below the mean?

Share your observations with a colleague or friend to get their thoughts.
